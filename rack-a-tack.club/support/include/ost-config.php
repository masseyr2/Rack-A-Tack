...
define('SECRET_SALT','
Strict Standards: Non-static method Misc::randCode() should not be called statically in /home2/masterzu/public_html/rack-a-tack.club/support/gensalt.php on line 5
aDo0.LOwNA.Sg1YUDrk0K5yI7NPcAl2W');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','support@rack-a-tack.club');

#Mysql Login info
define('DBTYPE','mysql');
define('DBHOST','localhost');
define('DBNAME','masterzu_stck1');
define('DBUSER','masterzu_stck1');
define('DBPASS','OxLsf1AzJD6T7Hr');
